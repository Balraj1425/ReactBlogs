...
const Home = () => {
    ...
    const [subscriber1, setSubcriber1] = useState();
    ...
    .then(subscriberData1 => {
        setSubcriber1(subscriberData1);
    })
    return (
        <>
        ...
        <div className="row">
            ...
            <div className="col-md-3 col-sm-3 col-xs-12">
                <div className='subs-wrapper'>
                    ...
                    <div className='subs'>
                        <img src={subscriber1["results"][0]["picture"]["medium"]} alt='subscriber pic'/>
                        {subscriber1["results"][0]["name"]["first"]} {subscriber1["results"][0]["name"]["last"]}
                    </div>
                    <div className='subs'>
